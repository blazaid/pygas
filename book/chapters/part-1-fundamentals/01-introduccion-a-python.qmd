...
trabajamos con código. Da igual que estés empezando o que lleves muchos años y quieras expandir tu s horizontes; Python
...
que fuera intuitivo y divertido, tanto para novatos como para expertos. Por eso, Python es un lenguaje que «piensa en el programador»: minimiza la complejidad técnica para que puedas concentrarte en resolver problemas.
